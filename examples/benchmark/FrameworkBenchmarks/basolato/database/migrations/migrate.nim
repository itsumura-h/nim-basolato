...
# https://github.com/TechEmpower/FrameworkBenchmarks/blob/master/toolset/databases/postgres/create-postgres.sql

proc main() =
  rdb.raw(""" DROP TABLE IF EXISTS "World"; """).exec().waitFor
  rdb.raw(""" DROP TABLE IF EXISTS "Fortune"; """).exec().waitFor
