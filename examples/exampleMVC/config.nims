...
putEnv("DB_CONNECTION", "/root/project/exampleMVC/db.sqlite3")
...
putEnv("LOG_DIR", "/root/project/exampleMVC/logs")
...
putEnv("SESSION_DB_PATH", "/root/project/exampleMVC/session.db")
