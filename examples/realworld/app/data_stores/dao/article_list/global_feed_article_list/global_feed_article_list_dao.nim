...
type GlobalFeedArticleListDao* = object of IGlobalFeedArticleListDao

proc new*(_:type GlobalFeedArticleListDao):GlobalFeedArticleListDao =
  return GlobalFeedArticleListDao()


method invoke*(
  self:GlobalFeedArticleListDao,
  offset:int,
  display:int,
