...
type UserFavoriteArticleListDao* = object of IUserArticleListDao

proc new*(_:type UserFavoriteArticleListDao): UserFavoriteArticleListDao = 
  return UserFavoriteArticleListDao()

method invoke*(
  self: UserFavoriteArticleListDao, 
  userId: string, 
  offset:int, 
  display:int
