...
type YourFeedArticleListDao* = object of IYourFeedArticleListDao

proc new*(_:type YourFeedArticleListDao):YourFeedArticleListDao =
  return YourFeedArticleListDao()


method invoke*(
  self:YourFeedArticleListDao,
  loginUserId:string,
  offset:int,
  display:int,
