...
proc show*(this:TodoRdbRepository, id:int):JsonNode =
  return rdb().table("todos").find(id)

proc store*(this:TodoRdbRepository, userId:UserId, title:TodoTitle, content:TodoDetail) =
