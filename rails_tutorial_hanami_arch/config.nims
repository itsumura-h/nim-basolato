...
putEnv("LOG_DIR", "/root/project/rails_tutorial/logs")

# Security
putEnv("SECRET_KEY", "bXvdDeIZN[T3^]5lMwe:3`d]") # 24 length
putEnv("CSRF_TIME", "525600") # minutes of 1 year
putEnv("SESSION_TIME", "20160") # minutes of 2 weeks
putEnv("SESSION_DB", "/root/project/rails_tutorial/session.db")
